...
public class RestauranteController {
	...
	/**
	 * Lista de restaurantes consultados para la tabla.
	 */
	List<Restaurante> restaurantes;
	/**
	 * servicio que realiza la logica de negocio para restaurantes.
	 */
	RestauranteService restauranteService = new RestauranteService();
	
	/**
	 * Metodo que inicializa la informacion en la pagina restaurantes.xhtml
	 */
	@PostConstruct
	public void init() {
	...
	/**
	 * Metodo que se encarga de consultar la lista de restaurantes
	 */
